...
public class IqSkill extends Fragment {
    ...
    private static String JSON_URI = "https://gadsapi.herokuapp.com/api/skilliq";
            ...
            public void onResponse(JSONArray response) {
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        Student student = new Student(studentObject.getString("name"),studentObject.getString("score"),studentObject.getString("country"),studentObject.getString("badgeUrl"));
